...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        Object[] columns1 = {"Pay To","Your Reference","Date Time","Amount","Status"};
...
//      ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM All_transactions  WHERE user_nic = "+Integer.parseInt(UID));

            while (rs.next()) {
                row1[0] = rs.getString("Pay_to");
                row1[1] = rs.getString("Your_reference");
                row1[2] = rs.getString("Date_time");
                row1[3] = rs.getString("Amount");
                row1[4] = rs.getString("Status");
