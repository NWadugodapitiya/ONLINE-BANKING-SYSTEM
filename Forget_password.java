...
// Your Email
        ...
        JLabel l4 = new JLabel ("User Full Name");
            ...
            public void keyPressed(final KeyEvent ke){
                ...
                if (keypad == KeyEvent.VK_ENTER){
                    ...
                    try{
                        ...
                        Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/banking_system","root","");
                        Statement st = (Statement) con.createStatement ();
                        ResultSet rs=st.executeQuery("SELECT * FROM user WHERE user_id = '"+t1.getText()+ "' && full_name ='"+t2.getText()+ "' && user_nic ='"+t3.getText()+"'");


                        if (rs.next()){

                            t4.setBounds(578,285,235,34);
        ...
        t4.addKeyListener(new KeyAdapter() {
            public void keyPressed(final KeyEvent ke){
                ...
                if (keypad == KeyEvent.VK_ENTER){
                    ...
                    try{
                        Class.forName("com.mysql.jdbc.Driver");
                        Connection conx = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/banking_system","root","");

                        java.sql.Statement stmtx = conx.createStatement();
                        pstx = (PreparedStatement) conx.prepareStatement("update user set password=? WHERE user_id ="+t1.getText());
