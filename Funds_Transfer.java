...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        JLabel GClass = new JLabel (" Funds Transfer");
        GClass.setBounds(226,18,360,54);
...
//------------------------------------------------------------------------------------------------------------------------------
        JLabel bu = new JLabel ("  Transfer");
        bu.setBounds(748,439,101,24);
...
//===============================================================================================================================
        ...
        try {
            ...
            ResultSet rss = st.executeQuery("SELECT * FROM payees WHERE user_id = " + Integer.parseInt(UID));
            while (rss.next()) {
                        ...
                        if (myBalance >= amountToSubtract) {
                            ...
                            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost/banking_system", "root", "")) {
                                ...
                                try (PreparedStatement transactionStmt = con.prepareStatement(insertTransactionQuery)) {
                                    ...
                                    transactionStmt.setString(4, t1.getText());
                                    ...
                                    if (rowsAffected > 0) {
                                        JOptionPane.showMessageDialog(null, "Transfer success", "Transfer OK", JOptionPane.WARNING_MESSAGE);
                                        ...
                                        JOptionPane.showMessageDialog(null, "Transfer failed", "Transfer Error", JOptionPane.ERROR_MESSAGE);
                                    }
                                }
                            }
                        } else {
                            JOptionPane.showMessageDialog(null, "Insufficient balance. Cannot Transfer.");
                        }
