...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        // Create a document filter to limit the number of characters
        ((AbstractDocument) t1.getDocument()).setDocumentFilter(new LengthLimitDocumentFilter(10));
...
//------------------------------------------------------------------------------------------------------------------------------
  ...
  try{
            ...
            rs=st.executeQuery("select max(Account_number) from user_register");
            int i = 0;
            while (rs.next())
            {
                i=rs.getInt(1);
...
//-------------------------------------------------------------------------------------------------------------------------------
        ...
        JLabel saving2 = new JLabel("Balance");
        ...
        t4.addKeyListener(new KeyAdapter() {
            public void keyPressed(final KeyEvent ke) {
                ...
                if (keypad == KeyEvent.VK_ENTER) {
                    ...
                    if (t2.getText().isEmpty()) {
                        q9.setText("Type Ful Name");

                    }

                    if (t3.getText().isEmpty()) {
                        q9.setText("Type Email");
                    ...
                    if (t1.getText().isEmpty() && t2.getText().isEmpty() && t3.getText().isEmpty() && t4.getText().isEmpty()) {
                        ...
                        try{
                            ...
                            String userRegisterQuery = "INSERT INTO user_register (user_nic, password, email, full_name, date_of_birth, update_date, Tel1, Address, date_time, Account_number) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                            ...
                            userRegisterStmt.setString(1, t1.getText()); // user_nic
                            userRegisterStmt.setString(2, t4.getText()); // password
                            userRegisterStmt.setString(3, t3.getText()); // email
                            userRegisterStmt.setString(4, t2.getText()); // full_name
                            userRegisterStmt.setString(5, ""); // date_of_birth
                            userRegisterStmt.setString(6, formattedDate); // update_date
                            userRegisterStmt.setString(7, ""); // Tel1
                            userRegisterStmt.setString(8, ""); // Address
                            userRegisterStmt.setString(9, formattedDate); // date_time
                            userRegisterStmt.setInt(10, Integer.parseInt(acount_n.getText())); // Account_number

                            userRegisterStmt.execute();

                            // Insert into accounts table
                            String accountsQuery = "INSERT INTO accounts (user_nic, accounts_name, amount, date_time) VALUES (?, ?, ?, ?)";
                            PreparedStatement accountsStmt = con.prepareStatement(accountsQuery);

                            accountsStmt.setString(1, t1.getText());
                            accountsStmt.setString(2, saving2.getText());
                            accountsStmt.setString(3, balance.getText());
                            accountsStmt.setString(4, formattedDate);

                            accountsStmt.execute();

                            String accountsQuerye = "INSERT INTO accounts (user_nic, accounts_name, amount, date_time) VALUES (?, ?, ?, ?)";
                            PreparedStatement accountsStmte = con.prepareStatement(accountsQuerye);

                            accountsStmte.setString(1, t1.getText());
                            accountsStmte.setString(2, saving.getText());
                            accountsStmte.setString(3, balance.getText());
                            accountsStmte.setString(4, formattedDate);

                            accountsStmte.execute();
...
//------------------------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        System.out.println(String.valueOf(Register.generate(0,999999999)));
...
class LengthLimitDocumentFilter extends DocumentFilter {
    ...
    public void replace(FilterBypass fb, int offset, int length, String text, AttributeSet attrs) throws BadLocationException {
        ...
        int remainingSpace = maxLength - currentLength + length;
