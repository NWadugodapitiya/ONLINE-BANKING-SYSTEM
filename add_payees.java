...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        L4.setBounds(249,324,145,23);
        L4.setForeground(new Color(112, 112, 112, 255));
        add(L4);
        L4.setFont(Atet2);

        JLabel L5 = new JLabel ("Email");
        L5.setBounds(249,375,55,23);
        L5.setForeground(new Color(112, 112, 112, 255));
        add(L5);
        L5.setFont(Atet2);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (t1.getText().isEmpty() || t2.getText().isEmpty() || t3.getText().isEmpty() || dura.getSelectedItem().equals("Select the bank")) {
                    ...
                    try{
                        ...
                        String userRegisterQuery = "INSERT INTO payees (user_nic, Bank, Account_number,Account_name,Nick_name,Phone_number,Email) VALUES (?, ?, ?, ?, ?, ?, ?)";
                        ...
                        userRegisterStmt.setString(6, t4.getText());
                        userRegisterStmt.setString(7, t5.getText());
